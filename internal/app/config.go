...
func LoadConfig() Config {
	...
	return Config{
		...
		MemLimit:               getenv("CTF_AGENT_MEM_LIMIT", "auto"),
		CPUs:                   getenv("CTF_AGENT_CPUS", "auto"),
		MaxContainers:          getenvInt("CTF_AGENT_MAX_CONTAINERS", 1),
		...
		OpenCodeRunTimeout:     getenvDuration("CTF_AGENT_OPENCODE_RUN_TIMEOUT", 0),
		OpenCodeIdleTimeout:    getenvDuration("CTF_AGENT_OPENCODE_IDLE_TIMEOUT", 0),
